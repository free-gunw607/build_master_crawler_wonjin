...
- Next automatic task: stabilize IH/JBDC remote TLS/availability and finish GMCC/GDCO/GBDC/GNDC scope filters; overlap-ambiguous GH candidate remains disabled.
