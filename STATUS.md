...
## Current blockers
- source-specific production failures are now isolated: GMCC remains active after workflow `29359719171`; IH remains disabled after CI timeout in `29359900687`, JBDC after CI TLS handshake failure in `29360120068`, and SCTC after current CI 404. Failed source IDs/errors are written to runlog and Telegram while the remaining sources continue.
